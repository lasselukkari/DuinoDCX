...
export class DeviceSession {
    // Phase
    private phase: DevicePhase = DevicePhase.DISCONNECTED;
    ...
    // Edit buffer state
    private readonly editBufferParts = new Map<number, Uint8Array>();
    private nextEditBufferPart = 0;
    private editBufferState: State | undefined = undefined;

    // Preset download state
    private readonly presetPages = new Map<number, Uint8Array>();
    private nextPresetPage = 0;
    private presetData: Uint8Array | undefined = undefined;
     ...
     */
    public setPingEnabled(enabled: boolean): void {
     ...
     */
    public getPresetData(): Uint8Array | undefined {
    ...
    private handleSearching(message: ParsedMessage): void {
    ...
    private handleSyncing(message: ParsedMessage): void {
    ...
    private handleDownloadingPresets(message: ParsedMessage): void {
    ...
    private assembleEditBuffer(): void {
        try {
    ...
    private queueEditBufferRequest(part: number): void {
        this.messageQueue.push(buildEditBufferRequest(part as 0 | 1, this.deviceId));
    }
