...
function buildMappings() {
    const setup: Map<number, ParamMapping> = new Map();
    const inputOutput: Map<number, ParamMapping>[] = [];
    const outputOnly: Map<number, ParamMapping>[] = [];
    const eq: Map<number, ParamMapping>[][] = [];
