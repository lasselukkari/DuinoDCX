...
import TransferFunction from './transfer-function-new.ts';
...
describe('generateFrequencyPoints', () => {
    it('returns correct result', () => {
        ...
        expect(points[1]).toBeCloseTo(66.8740304976, 8);
        expect(points[2]).toBeCloseTo(447.2135955, 8);
        expect(points[3]).toBeCloseTo(2990.69756244, 8);
        expect(points[4]).toBeCloseTo(20000, 8);
    });
});
...
describe('shelving', () => {
    it('low shelving works', () => {
        const tf = new TransferFunction([100, 1000, 10000]);
