...
export declare const directLookup: Map<
  `${number}:${number}`,
  ParameterDefinition
>;
/**
 ...
 */
export declare function getParameterByByte(
  index: number,
): ParameterDefinition | undefined;
/**
 * Get parameter definition by direct command address.
 */
export declare function getParameterByDirect(
  channel: number,
  parameter: number,
): ParameterDefinition | undefined;
/**
 ...
 */
export declare function convertValue(
 ...
 */
export declare function toRawValue(
  def: ParameterDefinition,
 ...
 */
export declare function applyToState(
  state: any,
  def: ParameterDefinition,
  value: boolean | string | number,
): void;
