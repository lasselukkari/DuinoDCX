 ...
 */
export declare function buildPageDumpRequest(
  page: number,
  deviceId?: number,
): Uint8Array;
/**
 ...
 */
export declare function buildEditBufferRequest(
  part: 0 | 1,
  deviceId?: number,
): Uint8Array;
/**
 ...
 */
export declare function buildListenModeCommand(
  mode?: number,
  state?: number,
  deviceId?: number,
): Uint8Array;
 ...
 */
export declare function buildRecallCommand(
  slot: number,
  deviceId?: number,
): Uint8Array;
/**
 ...
 */
export declare function buildStoreCommand(
  slot: number,
  deviceId?: number,
): Uint8Array;
/**
 ...
 */
export declare function buildDataPacket(
  type: number,
  pageNumber: number,
  data: Uint8Array,
  deviceId?: number,
 ...
 */
export declare function buildHeaderPacket(
  data: Uint8Array,
  deviceId?: number,
): Uint8Array;
/**
 ...
 */
export declare function buildPagePacket(
  pageNumber: number,
  data: Uint8Array,
  deviceId?: number,
): Uint8Array;
 ...
 */
export declare function buildDirectCommand(
  parameters: Array<{
    channel: number;
    param: number;
    value: number;
 ...
 */
export declare function buildParameterChangeCommand(
