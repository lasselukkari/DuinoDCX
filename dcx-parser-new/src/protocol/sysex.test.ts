...
describe('sysex', () => {
  ...
  describe('buildPageDumpRequest', () => {
    it('should build correct page dump request', () => {
      ...
      expect(cmd).toEqual(
        new Uint8Array([0xf0, 0x00, 0x20, 0x32, 0x01, 0x0e, 0x50, 0x00, 0x00, 0x05, 0xf7]),
      );
    });
  ...
  describe('buildEditBufferRequest', () => {
    it('should build correct edit buffer request for part 0', () => {
      ...
      expect(cmd).toEqual(
        new Uint8Array([0xf0, 0x00, 0x20, 0x32, 0x00, 0x0e, 0x50, 0x01, 0x00, 0x00, 0xf7]),
      );
    });
    ...
    it('should build correct edit buffer request for part 1', () => {
      ...
      expect(cmd).toEqual(
        new Uint8Array([0xf0, 0x00, 0x20, 0x32, 0x00, 0x0e, 0x50, 0x01, 0x00, 0x01, 0xf7]),
      );
    });
  });
  ...
  describe('buildDirectCommand', () => {
    it('should build correct direct command for single parameter', () => {
      ...
      // Hi = 2, Lo = 44 (0x2C)
      expect(cmd).toEqual(
        new Uint8Array([0xf0, 0x00, 0x20, 0x32, 0x00, 0x0e, 0x20, 0x01, 0x00, 0x01, 0x02, 0x2c, 0xf7]),
      );
    });
  });
