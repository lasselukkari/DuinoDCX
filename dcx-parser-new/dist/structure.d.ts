...
export declare const EDIT_BUFFER_SETUP_PARAMS: ParamDef[];
export declare const PRESET_SETUP_PARAMS: ParamDef[];
export declare const INPUT_CHANNEL_PARAMS: ParamDef[];
export declare const EQ_BAND_PARAMS: ParamDef[];
export declare const OUTPUT_CHANNEL_PARAMS_PREFIX: ParamDef[];
export declare const OUTPUT_EXTRA_PARAMS: ParamDef[];
