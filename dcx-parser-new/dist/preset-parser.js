...
import { PRESET_SETUP_PARAMS, INPUT_CHANNEL_PARAMS, EQ_BAND_PARAMS, OUTPUT_CHANNEL_PARAMS_PREFIX, OUTPUT_EXTRA_PARAMS, INPUT_NAMES, OUTPUT_NAMES, INPUT_EQ_COUNT, OUTPUT_EQ_COUNT, } from './structure.js';
import { readString, readU16LE, readBytes, parseSequential, } from './parser-utils.js';
...
function parseInputChannel(cursor) {
...
function parseOutputChannel(cursor) {
