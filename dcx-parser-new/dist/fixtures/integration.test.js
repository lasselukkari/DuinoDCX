 ...
 */
function normalizeForJsonComparison(obj) {
...
describe('State Integration Test', () => {
    ...
    it('should reconstruct state from binary chunks and match browser capture', () => {
        ...
        const expectedJson = fs.readFileSync(path.join(actualFixturesDir, 'current-state-browser.json'), 'utf-8');
    ...
    it('should parse preset 0 and preset 36 with matching values (locked factory copy)', () => {
        ...
        const dcxData = new Uint8Array(fs.readFileSync(path.join(actualFixturesDir, 'factory-presets.dcx')));
