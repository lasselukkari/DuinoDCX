...
const SYSEX_FILE = path.join(process.cwd(), 'test-data/verification/edit_buffer.sysex');
function main() {
    ...
    fs.writeFileSync(path.join(process.cwd(), 'test-data/verification/edit_buffer_decoded_new.bin'), fullDecoded);
...
main();
//# sourceMappingURL=decode-edit-buffer.js.map