...
function extractAndDecode(sysexStream, _type) {
    // Split into messages
    const messages = [];
    let start = -1;
...
function main() {
    try {
        ...
        fs.writeFileSync(path.join(DATA_DIR, 'preset_00_calibration.bin'), p0Decoded);
...
main();
//# sourceMappingURL=verify-presets.js.map