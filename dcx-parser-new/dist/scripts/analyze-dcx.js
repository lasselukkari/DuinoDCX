...
function analyzeDcx(filename) {
    ...
    for (let i = 20; i < 200; i++) {
        ...
        if (u1 <= 2 && u2 === 0 && m1 <= 1 && m2 === 0) {
            console.log(`Potential Setup start at ${i}: DelayUnits=${u1}, Mute=${m1}`);
        }
    }
}
analyzeDcx('src/fixtures/current.dcx');
//# sourceMappingURL=analyze-dcx.js.map