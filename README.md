...
If you want to make the UI available in your local network open the config panel. Fill in your wifi credential and submit the form. Wifi credentials are persisted to the device memory.
